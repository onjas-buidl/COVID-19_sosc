...
p = pd.read_excel('CN_Provinces/CN_Policy-不用了/V1-Yuhang_Pan-CN_lockdown_data.xlsx')
...
p.to_excel('CN_Provinces/CN_Policy-不用了/V2-Yuhang_Pan-CN_lockdown_data.xlsx')

...
xg1 = pd.read_csv('Gov_data/CH_policy_zky/新冠1.csv')
xg2 = pd.read_csv('Gov_data/CH_policy_zky/新冠2.csv')
...
plt.title('2020年一月到四月各省疫情防控以及复产复工政策数量汇总')
plt.xticks(rotation=45)
leg = plt.legend()
# plt.savefig('Gov_data/CH_policy_zky/Graphs/control-relax_policy_by_prov.png', dpi=300)
plt.show()
...
plt.xticks(rotation=45)
leg = plt.legend()
plt.savefig('Gov_data/CH_policy_zky/Graphs/2020年一月到四月各省strigency_index.png', dpi=300)
# plt.show()
...
plt.savefig('Gov_data/CH_policy_zky/Graphs/initial_control_policy_by_prov.png', dpi=300)
# plt.show()
...
plt.savefig('Gov_data/CH_policy_zky/Graphs/relax_policy_by_prov.png', dpi=300)
# plt.show()
...
leg = ax.legend()
# plt.show()
plt.savefig('Gov_data/CH_policy_zky/Graphs/随时间变化-'+reduce(lambda i,j: i+j, prov_list) +'.png')
